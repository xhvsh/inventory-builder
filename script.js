...
fetch("https://valorant-api.com/v1/weapons")
  ...
  .then((data) => {
    ...
    let dat = {
      ...
      sheriff: { name: "sheriff", id: 10, defaultId: 35, activeId: 35, variant: 0 },
      stinger: { name: "stinger", id: 16, defaultId: 24, activeId: 24, variant: 0 },
      spectre: { name: "spectre", id: 15, defaultId: 42, activeId: 42, variant: 0 },
      bucky: { name: "bucky", id: 6, defaultId: 29, activeId: 29, variant: 0 },
      ...
      vandal: { name: "vandal", id: 2, defaultId: 56, activeId: 56, variant: 0 },
      ...
      melee: { name: "melee", id: 17, defaultId: 90, activeId: 90, variant: 0 },
    };
    var tempActive;
    var tempVariant = 0;
